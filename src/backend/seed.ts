...
const products = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1624701928517-44c8ac49d93c?auto=format&fit=crop&q=80&w=1000",
    featured: true,
  ...
  },
  {
    ...
    stockCount: 15,
    category: "Keyboards",
    imageUrl: "https://images.unsplash.com/photo-1618384800394-2456b59accf6?auto=format&fit=crop&q=80&w=1000",
    featured: false,
  ...
  },
  {
    ...
    stockCount: 20,
    category: "Cases",
    imageUrl: "https://images.unsplash.com/photo-1587831990711-23ca6441447b?auto=format&fit=crop&q=80&w=1000",
    featured: false,
  ...
  },
  {
    ...
    stockCount: 18,
    category: "Memory",
    imageUrl: "https://images.unsplash.com/photo-1563770660941-20978e870813?auto=format&fit=crop&q=80&w=1000",
    featured: false,
  ...
  },
  {
    ...
    stockCount: 5,
    category: "Processors",
    imageUrl: "https://images.unsplash.com/photo-1555617766-c94804975da3?auto=format&fit=crop&q=80&w=1000",
    featured: true,
  ...
  },
  {
    ...
    stockCount: 3,
    category: "Cases",
    imageUrl: "https://images.unsplash.com/photo-1625842268584-8f3bf9ff16a1?auto=format&fit=crop&q=80&w=1000",
    featured: true,
  ...
  },
  {
    ...
    stockCount: 8,
    category: "Cooling",
    imageUrl: "https://images.unsplash.com/photo-1588505794041-9c3222f8537b?auto=format&fit=crop&q=80&w=1000",
    featured: false,
...
export async function seedDatabase() {
  try {
    ...
    if (count >= products.length) {
      console.log('🌱 Database already contains sufficient elite gear. Skipping...');
      return;
    }

    console.log('🌱 Refreshing database with the full 20-unit elite manifest...');
    await Product.deleteMany({}); // Ensure fresh state on seed update
